...
func tmplChangelogHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/changelog.html", size: 1747, mode: os.FileMode(420), modTime: time.Unix(1453467765, 0)}
...
func tmplIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/index.html", size: 3688, mode: os.FileMode(420), modTime: time.Unix(1453467765, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
